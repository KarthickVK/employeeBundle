...
import com.launchclub.databaseconnection.ConnectDataBase;
...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public boolean updateEmployee(final Employee employeeDetails) {
		...
		try (Connection connection = ConnectDataBase.getConnection();) {
			...
			if (employeeDetails.getEmployeePhoneNo() != null) {
				prepareStatement.setString(employeePhoneNoIndex, employeeDetails.getEmployeePhoneNo());
			}
